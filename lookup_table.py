...
def calc_corr_AoA(file12, file13, prn, phase_ch_2, lookup_table, plot_corr=False):
    ...
    corr1, corr2 = prepareDataForMonopulse(file12, prn, False, phase_ch_2, False, False)
    phase12 = calc_corr_phase_shift(corr1, corr2, plot_corr=plot_corr)
    corr1, corr3 = prepareDataForMonopulse(file13, prn, False, phase_ch_2, False, False)
